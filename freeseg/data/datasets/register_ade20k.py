...
import random
stuff_colors150 = [[random.randint(0,255), random.randint(0,255), random.randint(0,255)] for i in range(150)]
stuff_colors847 = [[random.randint(0,255), random.randint(0,255), random.randint(0,255)] for i in range(847)]
...
def register_all_ade20k(root):
    ...
    for name, dirname in [("train", "training"), ("val", "validation")]:
        ...
        gt_dir = os.path.join(root, "annotations_detectron2", dirname)
        name = f"my_ade20k_sem_seg_{name}"
        DatasetCatalog.register(
