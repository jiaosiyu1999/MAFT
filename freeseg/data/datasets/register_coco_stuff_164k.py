...
for i in COCO_CATEGORIES:
    if 'color' in list(i.keys()):
        stuff_colors.append(i['color'])
    else:
        stuff_colors.append([random.randint(0,255), random.randint(0,255), random.randint(0,255)])
...
def _get_coco_stuff_meta():
    ...
    # stuff_colors = [k["name"] for k in COCO_CATEGORIES]
...
_root = os.getenv("DETECTRON2_DATASETS", "datasets/coco")
