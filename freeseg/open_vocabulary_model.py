...
class OpenVocabulary(MaskFormer):
    ...
    def forward(self, batched_inputs, text_labels=None):
        ...
        if self.training:        
            ...
            processed_results = []
            for mask_cls_result, mask_pred_result, input_per_image, image_size, clip_image in zip(
                mask_cls_results, mask_pred_results, batched_inputs, images.image_sizes, clip_images_480
            ):
                height = image_size[0]
                width = image_size[1]
                ...
                r = self.semantic_inference(
                    mask_cls_result, mask_pred_result, clip_image.unsqueeze(0), class_names, dataset_name
                )
    ...
    def semantic_inference(self, mask_cls, mask_pred, image, class_names, dataset_name):
        ...
        if self.clip_ensemble:
            ...
            if self.clip_ensemble_weight > 0:
                ...
                map_back_clip_cls[valid_flag] = clip_cls[valid_flag]
