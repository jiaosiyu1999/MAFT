...
import freeseg.data.datasets.register_ade20k.ADE20K_SEM_SEG_FULL_CATEGORIES as ADE20K_SEM_SEG_FULL_CATEGORIES
...
if __name__ == "__main__":
    ...
    for folder_name, file_name in tqdm.tqdm(
        ...
        output_img = dataset_dir / "ade20k/ADE20K_2021_17_01" / "images_detectron2" / split / file_name
        output_lab = (
            dataset_dir
